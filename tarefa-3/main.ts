...
interface FuncionarioVoluntario extends Pesquisador {
    escreveRelatorio(): void;
    pesquisa(): void;
}
...
class FuncionarioVoluntario implements FuncionarioVoluntario {
    ...
    constructor(nome: string, cargaHorariaExtensao: number, funcionarioEfetivo: Funcionario) {
...
funcionarioVoluntario.pesquisa();